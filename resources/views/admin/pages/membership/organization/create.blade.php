...
<nav aria-label="breadcrumb mb-3">
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active" aria-current="page">ایجاد سازمان</li>
    </ol>
</nav>
        ...
        <div class="col-12 mb-4">
            ...
            <div class="bs-stepper wizard-numbered mt-2">
                ...
                <div class="bs-stepper-content">
                    <form action="{{ route('admin.membership.organization.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div id="account-details" class="content active dstepper-block">
                            ...
                            <div class="row g-3">
                                <div class="col-sm-6">
                                    ...
                                    <input type="text" name="name" id="name" value="{{ old('name') }}" class="form-control text-start"  placeholder="امور شعب بانک ملی">
                                    <div class="mt-1">
                                        @error('name')
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    @if (old('parent_id')) 
                                        @php
                                            $orgId = App\Models\Membership\Organization::where('id', old('parent_id'))->first(); 
                                        @endphp
                                    @endif
                                        <select id='parent_id' class="select2" name="parent_id"> 
                                            @if (old('parent_id')) <option value="{{$orgId['id']}}" selected>{{ $orgId['name'] }}</option> @endif
                            ...
                            <div class="row g-3">
                                <div class="col-md-6 mt-5">
                                    ...
                                    <div class="position-relative"">
                                        @if (old('manager_id'))
                                            @php
                                                $manager = App\Models\Membership\User::where('id', old('manager_id'))->first();
                                            @endphp
                                        @endif
                                ...
                                <div class="col-md-6 mb-4 text-center">
                                    <div class="button-wrapper">      
                                        <div class="mb-2">
                                            <img src="{{ asset(env('AVATAR_ORG')) }}" alt="user-avatar" class="d-block rounded mx-auto" height="100" width="100" id="uploadedAvatar">
                                        </div>                      
