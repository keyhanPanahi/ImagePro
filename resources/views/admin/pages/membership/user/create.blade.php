    ...
    <div class="col-12 mb-4">
        <div class="bs-stepper wizard-numbered mt-2">
            ...
            <div class="bs-stepper-content">
                <form action="{{ route('admin.membership.user.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div id="account-details" class="content active dstepper-block">
                        ...
                        <div class="row g-3">
                            <div class="col-sm-6">
                                ...
                                <input type="text" name="username" id="username" value="{{ old('username') }}" class="form-control text-start" dir="ltr" placeholder="0640832145">
                                <div class="mt-1">
                                    @error('username')
                            ...
                            <div class="col-sm-6">
                                ...
                                <input type="text" name="email" id="email" value="{{ old('email') }}" class="form-control text-start" dir="ltr" placeholder="ahmad@gmail.com">
                                <div class="mt-1">
                                    @error('email')
                                    <span class="text-danger">* {{ $message }}</span>
                                    @enderror
                    ...
                    <div id="personal-info" class="content">
                        ...
                        <div class="row g-3">
                            <div class="col-sm-6">
                                ...
                                <input type="text" name="first_name" id="first_name" value="{{ old('first_name') }}" class="form-control" placeholder="محمد">
                                <div class="mt-1">
                                    @error('first_name')
                                    <span class="text-danger">* {{ $message }}</span>
                                    @enderror
                            ...
                            <div class="col-sm-6">
                                ...
                                <input type="text" id="last_name" name="last_name" value="{{ old('last_name') }}" class="form-control" placeholder="خسروی">
                                <div class="mt-1">
                                    @error('last_name')
                                    <span class="text-danger">* {{ $message }}</span>
                                    @enderror
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="sex_id" id="sex_id" class="select2">
                                    @foreach ($sexes as $sex)
                                        <option value="{{ $sex->id }}" @if(old('sex_id') == $sex->id) selected @endif>{{ $sex->name }}</option>
                                    @endforeach
                                </select>
                                <div class="mt-1">
                                    @error('sex_id')
                            ...
                            <div class="col-sm-6">
                                ...
                                <input type="text" name="mobile" id="mobile" value="{{ old('mobile') }}" class="form-control" placeholder="09151234567">
                                <div class="mt-1">
                                    @error('mobile')
                                    <span class="text-danger">* {{ $message }}</span>
                                    @enderror
                            ...
                            <div class="col-sm-6">
                                ...
                                <input type="text" name="address" id="address" value="{{ old('address') }}" class="form-control" placeholder="بیرجند، خیابان مدرس 13">
                                <div class="mt-1">
                                    @error('address')
                                    <span class="text-danger">* {{ $message }}</span>
                                    @enderror
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6 mb-3" data-select2-id="45">
                                ...
                                <div class="position-relative" data-select2-id="44">
                                    @php
                                        $organization = \App\Models\Membership\Organization::where('id',old('organization_id'))->first();
                                    @endphp
                                    <select name="organization_id" id="organization_id" class="select2 form-select form-select-lg " data-allow-clear="true" data-select2-id="select2Basic" tabindex="-1" aria-hidden="true">
                                        @if (old('organization_id')) <option value="{{ $organization->id }}" selected>{{ $organization->title }}</option> @endif
                                    </select>
                                </div>
                                <div class="mt-1">
                            ...
                            <div class="col-md-6 text-center">
                                <div class="button-wrapper">
                                    <img src="{{ asset(env('AVATAR_MAN')) }}"  alt="user-avatar" class="d-block mx-auto rounded mb-3" height="100" width="100" id="uploadedAvatar">
                    ...
                    <div id="roles" class="content">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-3 col-6">
                                ...
                                <input type="checkbox" class="form-check-input" name="role[]" id="{{ $child->id }}" value="{{ $child->id }}" @if(is_array(old('role')) && in_array($child->id, old('role'))) checked @endif>
                                <div class="mt-2">
                                @error('role.'.$key)
