...
@section('title','مدیریت - ایجاد نقش جدید')
...
@section('content')
    ...
    {{-- form - createRole --}}
    <div class="card mb-1">
        <form class="card-body" action="{{ route('admin.membership.role.store') }}" method="post">
            @csrf
            <div class="row g-3">
                <div class="col-md-6">
                ...
                <div class="row">
                    ...
                    @foreach ($permissions as $permission)
                        @php
                            $rand = $icons[array_rand($icons,1)];
                        @endphp
                        <div class="col-lg-3">
                            <br>
                            @if ($permission->parent_id == null)
                                <small class="text-light fw-semibold badge bg-label-{{$rand}}">{{$permission->title}} </small>
                            @endif
